 ...
 */
public class BLEScanListAdapter extends RecyclerView.Adapter<BLEScanListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            textView = (TextView) view.findViewById(R.id.ble_scan_list_row_item);
        }
     ...
     */
    public BLEScanListAdapter(ArrayList<BluetoothDevice> bluetoothDevices, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.fragment_scan_devices_row_item, viewGroup, false);
